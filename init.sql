...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'JunctionServiciuJudete' AND COLUMN_NAME = 'Phone')
BEGIN
    ALTER TABLE JunctionServiciuJudete
    ADD Phone NVARCHAR(10);
END;

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'JunctionServiciuJudete' AND COLUMN_NAME = 'Email')
BEGIN
    ALTER TABLE JunctionServiciuJudete
    ADD Email NVARCHAR(50);
END;

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Users' AND COLUMN_NAME = 'IsAdmin')
BEGIN
    ALTER TABLE Users
    ADD IsAdmin BIT;
END;
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'JunctionServiciuJudete' AND COLUMN_NAME = 'Ofer')
BEGIN
    ALTER TABLE JunctionServiciuJudete
    ADD Ofer BIT;
END;
